    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http, JwtValidationFilter jwtValidationFilter) throws Exception {
        ...
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/products/oudiac/**","/api/category/oudiac/**","/api/brand/oudiac/**","/api/product-type/oudiac/**","/api/orders/oudiac/manager/**","/api/order-history/oudiac/**","/api/order-charges/oudiac/manager/**").hasAnyAuthority("ADMIN", "MANAGER")
